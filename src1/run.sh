...
python ../upload_slack.py "$RECORD_DIR/11weight.png"
python ../upload_slack.py "$RECORD_DIR/12weight.png"
python ../upload_slack.py "$RECORD_DIR/13weight.png"
python ../upload_slack.py "$RECORD_DIR/24weight.png"
python ../upload_slack.py "$RECORD_DIR/35weight.png"
python ../upload_slack.py "$RECORD_DIR/45weight.png"