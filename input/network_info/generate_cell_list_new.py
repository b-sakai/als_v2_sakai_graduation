...
PN_default[0].setBase(cellid = 2, swcid = 0, swcpath = "../input/swc/717_registrated_v3.swc", ppath = "none", synpath = "none",fromRN = "../input/synapse_list/fromRN/717_SynapseList.dat")
...
s300_200_precmpts = [20241, 17542, 16002, 16726, 21637, 21751, 21637, 21847, 22375, 17308 ]
s300_200_pstcmpts = [21,    23,    24,    25,    26,    27,    28,   29,     30,    31 ]
s300_200.set_precmpts(s300_200_precmpts)
s300_200.set_pstcmpts(s300_200_pstcmpts)

s301_200 = SYNLIST()
s301_200.set_nconnections(10)
s301_200_precmpts = [2527, 2992, 3263, 4853, 5895, 6708, 7524, 5651, 6464, 3897 ]
s301_200_pstcmpts = [21,   22,   23,   24,   25,   26,   28,   29,   30,   31 ]
